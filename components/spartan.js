...
const updateCredit = person => {
  return Demolition.update(
    { _id: person._id },
    { $set: { credits: ++person.credits } }
  ).exec();
};
      ...
      attachments: [
        {
          ...
          } you are fined one credit for a violation of the Verbal Morality Statutes!`,
          footer: `You have been fined a total of ${++credits} credits`,
          thumb_url:
            'http://www.dystopianmovies.org/wp-content/uploads/raymond-cocteau-demolition-man-nathaniel-hawthorne-64x64.jpg',
        },
      ],
    };
  } catch (err) {
